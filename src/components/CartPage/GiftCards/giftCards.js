...
import defaultClasses from '@magento/venia-ui/lib/components/CartPage/GiftCards/giftCards.module.css';
import GiftCard from '@magento/venia-ui/lib/components/CartPage/GiftCards/giftCard';
...
const GiftCards = props => {
    ...
    return (
        <Form data-cy="GiftCards-form" getApi={setFormApi} onSubmit={applyGiftCard}>
