...
import PriceAdjustmentsGiftCard from './PriceAdjustments/priceAdjustmentsGiftCard';
...
import overrideClasses from 'src/styles/CheckoutPage/checkoutPage.module.css';
...
const CheckoutPage = props => {
    ...
    const classes = useStyle(defaultClasses, propClasses, overrideClasses);
    ...
    if (orderNumber && orderDetailsData) {
        ...
        const priceAdjustmentsCouponSection =
            checkoutStep === CHECKOUT_STEP.PAYMENT ? (
        ...
        const priceAdjustmentsGiftCardSection =
            checkoutStep === CHECKOUT_STEP.PAYMENT ? (
                <div className={classes.price_adjustments_container}>
                    <PriceAdjustmentsGiftCard setIsCartUpdating={setIsUpdating} />
                </div>
            ) : null;
        ...
        checkoutContent = (
            <div className={checkoutContentClass}>
                ...
                {priceAdjustmentsCouponSection}
                {priceAdjustmentsGiftCardSection}
                {reviewOrderButton}
                {itemsReview}
                {orderSummary}
                {placeOrderButton}
