...
export const usePaymentInformation = props => {
    const {
        ...
        shouldSubmit,
        isUpdating,
        needToRefreshPayment,
        setNeedToRefreshPayment
    } = props;
    ...
    const {
        ...
        refetch: refetchPaymentInformation
     ...
     */
    useEffect(() => {
        if(needToRefreshPayment) {
            setNeedToRefreshPayment(false);
 ...
 * @property {boolean} isUpdating Derived state that keeps track if cart is updating
 */