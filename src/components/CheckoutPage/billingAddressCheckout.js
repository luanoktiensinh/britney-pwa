...
import { useBillingAddressCheckout } from './useBillingAddressCheckout';

const BillingAddressCheckout = props => {
    ...
    const {
        ...
        errors
    } = useBillingAddressCheckout(props);
...
BillingAddressCheckout.propTypes = {
